...
class co2_ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        trenutna.text = String(Shared.instance.AllData[0].dioxide)+" ppm"
    ...
    func setData(){
        ...
        for i in (0...29){
            yValues.append(ChartDataEntry(x: Double(i), y: Shared.instance.AllData[i].dioxide))
        }
